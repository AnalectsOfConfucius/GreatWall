...
import com.hg.core.constant.RegularString;
...
public class StringUtil {
     ...
     * @see add by 杨帆
     */
    public static ArrayList<String> getSplitString(String string,
            String splitChar) {
    ...
    public static boolean isParagraph(String s, Boolean isRequired) {
    	return StringUtil.commonValidate(s, isRequired, "^[0-9a-zA-Z_\\u4e00-\\u9fa5\\uFE30-\\uFFA0]+$");
    }
    ...
    public static boolean isUrl(String s, Boolean isRequired) {
    	return StringUtil.commonValidate(s, isRequired,
