...
public class SessionValidFilter implements Filter {
   ...
   public static final String AUTH_KEY = "gh4itr4#$dp6aKHw#$(%845402fMNhk17fl";
   public static final String SHOPPING_CART_KEY = "f^#kjhgs(fg^ADSF&2cxrt%@dfg657!dfx6";
   public static final String WEIXIN_KEY = "d$%sadhgsa4#%skjdh@!3djf21#jsadg@3djs";
   ...
   public final static boolean isUserLogin(HttpServletRequest request) {
       ...
       Object user = session.getAttribute(WEIXIN_KEY);
       if (user != null) {
           return true;
       }
