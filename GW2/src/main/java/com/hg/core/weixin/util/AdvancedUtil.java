...
//import com.hg.core.weixin.entity.WeixinGroup;
//import com.hg.core.weixin.entity.WeixinMedia;
//import com.hg.core.weixin.entity.WeixinOauth2Token;
//import com.hg.core.weixin.entity.WeixinQRCode;
//import com.hg.core.weixin.entity.WeixinUserInfo;
//import com.hg.core.weixin.entity.WeixinUserList;
//import com.hg.core.weixin.message.resp.Article;
//import com.hg.core.weixin.message.resp.Music;
//
...
//	 *            接口访问凭证
//	 * @param jsonMsg
//	 *            json格式的模板定义Id消息（包括template_id_short）
//	 * @return true | false
//	 */
//	public static JSONObject sendTemplate(String accessToken, String jsonMsg) {
//		// 发送模板消息
//		String requestUrl = "https://api.weixin.qq.com/cgi-bin/message/template/send?access_token=ACCESS_TOKEN".replace("ACCESS_TOKEN", accessToken);
...
//	 * @return
//	 */
//	public static WeixinMedia uploadNews(String accessToken, String articles) {
//		// 上传图文消息（POST）
//		String requestUrl = "https://api.weixin.qq.com/cgi-bin/media/uploadnews?access_token=ACCESS_TOKEN";
//
//		requestUrl = requestUrl.replace("ACCESS_TOKEN", accessToken);
//		// 发起GET请求获取凭证
//		JSONObject jsonObject = CommonUtil.httpsRequest(requestUrl, "POST", articles);
//
//		WeixinMedia weixinMedia = null;
//		if (null != jsonObject) {
//			try {
...
//			} catch (JSONException e) {
//				// 上传图文消息失败
//				log.error("上传图文消息失败 errcode:{} errmsg:{}", jsonObject.getInt("errcode"), jsonObject.getString("errmsg"));
//			}
//		}
//		return weixinMedia;
//	}
...
//	 * @return true | false
//	 */
//	public static JSONObject sendGroupMessage(String accessToken, String jsonMsg) {
//		log.info("消息内容：{}", jsonMsg);
//		// 拼接请求地址
//		// 根据分组进行群发
//		// String requestUrl =
...
//		// 获取接口访问凭证
//		// String accessToken = CommonUtil.getAccessToken("wxb18e65ed1e32e54b",
//		// "6937ab97916a0d7dec214c9c610941cb")
//		// .getAccessToken();
//		// String accessToken = CommonUtil.getAccessToken("wxb18e65ed1e32e54b",
//		// "6937ab97916a0d7dec214c9c610941cb").getAccessToken();
//		// String accessToken =
//		// "X7sPUJuhwk0dgaBYfuz_L06qXXaciA15wsO9dhHtCx5_7bs9CKQYnVrbrOKhyF6M46kPpGElbcX3dLi3iFRCjg";
//
//		// String accessToken = CommonUtil.getAccessToken("wxb18e65ed1e32e54b",
//		// "6937ab97916a0d7dec214c9c610941cb").getAccessToken();
//		// String accessToken =
//		// "nNSss3N2tUexvHZvuizux36Jjf3mBIgDm36tdLnybfEHUKyFwWULBOh38Ygl4BYuv9w7Mbkq3WilYD_GOSCt2w";
//
...
//		//
//		// /**
//		// * 获取用户信息 o3jeFuHZmF4v-SpfR2_fIuHLX3uo, o3jeFuPw8SGg_Vjxx7GS2nqeDqbw
//		// */
//		// WeixinUserInfo user = getUserInfo(accessToken,
//		// "o3jeFuPw8SGg_Vjxx7GS2nqeDqbw");
...
//		// "http://localhost/weizhan_M-S/static/upload/1/2014/7/1408303454649.jpg");
...
//		// */
//		// String articles =
//		// "{\"articles\":[{\"thumb_media_id\":\"Eb9EnuWED7d3-0yIjCXl_uNvepJJhW_pYb2UiMVFFKrQbrn4aVrhyPzLvo8veG45\",\"author\":\"xxx\",\"title\":\"HappyDay\",	\"content_source_url\":\"www.baidu.com\",	\"content\":\"content\",	\"digest\":\"digest\",\"show_cover_pic\":\"1\"},{\"thumb_media_id\":\"Eb9EnuWED7d3-0yIjCXl_uNvepJJhW_pYb2UiMVFFKrQbrn4aVrhyPzLvo8veG45\",\"author\":\"xxx\",	\"title\":\"HappyDay\",	\"content_source_url\":\"www.qq.com\",	\"content\":\"content\",	\"digest\":\"digest\",\"show_cover_pic\":\"0\"}]}";
//		// WeixinMedia weixinMedia = uploadNews(accessToken, articles);
//		// System.out.println(weixinMedia.getMediaId());
//		// System.out.println(weixinMedia.getType());
//		// System.out.println(weixinMedia.getCreatedAt());
//
//		// /**
//		// * 群发消息 o3jeFuHZmF4v-SpfR2_fIuHLX3uo, o3jeFuPw8SGg_Vjxx7GS2nqeDqbw
//		// */
//		// String jsonNewsMsg =
//		// "{\"touser\":[\"o3jeFuHZmF4v-SpfR2_fIuHLX3uo\",\"o3jeFuPw8SGg_Vjxx7GS2nqeDqbw\"],\"mpnews\":{\"media_id\":\"oGFtVwlPF_BQwfRNGU1-KKaSEl-CQhYFUfQX-Ii32O4qxTgW9Xz3MR14aHjVFQgX\"},\"msgtype\":\"mpnews\"}";
//		// boolean isSend = sendGroupMessage(accessToken, jsonNewsMsg);
...
//		 */
//		// String jsonNewsMsg =
//		// "{\"touser\":[\"oKSHAt9EXdNH3GgR2X6XK-RWZF-0\"],\"mpnews\":{\"media_id\":\"Ci3CyaRfEZMR4st6uvhrgs7M6ym_ohtfQYO75vKxGuGXdDb0FZxK_cJo89SS09jc\"},\"msgtype\":\"mpnews\"}";
//		// // String jsonNewsMsg =
//		// "{\"touser\":[\"o3jeFuHZmF4v-SpfR2_fIuHLX3uo\",\"o3jeFuPw8SGg_Vjxx7GS2nqeDqbw\"],\"text\":{\"content\":\"你好！~欢迎...\"},\"msgtype\":\"text\"}";
//		// String jsonNewsMsg =
//		// "{\"filter\":{\"group_id\":\"0\"},\"mpnews\":{\"media_id\":\"oGFtVwlPF_BQwfRNGU1-KKaSEl-CQhYFUfQX-Ii32O4qxTgW9Xz3MR14aHjVFQgX\",},\"msgtype\":\"mpnews\"}";
//		// JSONObject jsonObject = sendGroupMessage(accessToken, jsonNewsMsg);
//		// System.out.println("errcode: " + jsonObject.getInt("errcode"));
//		// System.out.println("errmsg: " + jsonObject.getString("errmsg"));
//
//		// OAuth2授权
//		WeixinOauth2Token WeixinOauth2Token = getOauth2AccessToken("wxef27c3a3a2bcad93", "8d8fd0f3909700b60365667cdbe4fdb7", "02d77e33a19b2df20ab90bf2aebc38a7");
//		System.out.println("OpenId:" + WeixinOauth2Token.getOpenId() + " accessToken:" + WeixinOauth2Token.getAccessToken());
//
//		// http://v.duomi.me/?code=02d77e33a19b2df20ab90bf2aebc38a7&state=STATE
//
//		SNSUserInfo SNSUserInfo = getSNSUserInfo(WeixinOauth2Token.getAccessToken(), WeixinOauth2Token.getOpenId());
